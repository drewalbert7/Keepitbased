...
**Canonical next steps:** [`../docs/GROK_PAPER_TRADING_BOT_PLAN.md`](../docs/GROK_PAPER_TRADING_BOT_PLAN.md) — **Quant AGI Bot** ($10k simulated), dashboard layout (Deploy → Suggestions → Bot on `/quant-agi`), Karpathy autoresearch on daily P&amp;L. Also: [`../../todo.md` § Quant AGI agentic trading bot build-out](../../todo.md#quant-agi-agentic-trading-bot-build-out).
